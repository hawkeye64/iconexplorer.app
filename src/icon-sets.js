...
const iconSets = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Radix-UI Icons', value: 'radix-ui-icons', packageName: 'quasar-extras-svg-icons', status: 'new' },
      ...
      { label: 'System UIcons', value: 'system-uicons', packageName: 'quasar-extras-svg-icons', status: 'new' },
