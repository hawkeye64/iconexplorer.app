...
const iconSets = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Linear Icons', value: 'linecons', packageName: 'quasar-extras-svg-icons', icons: true, status: 'v1.14' },
      { label: 'Linecons', value: 'linear-icons', packageName: 'quasar-extras-svg-icons', icons: true, status: 'v1.14' },
